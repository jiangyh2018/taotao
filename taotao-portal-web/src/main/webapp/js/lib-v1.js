...
var category = {OBJ: $("#_JD_ALLSORT"),
		...
		URL_Serv: "http://rest.tianfang1314.cn/rest/rest/itemcat/list?callback=category.getDataService",
...
//                        continue;
//                    if (0 == i) {
//                        if ("string" == typeof y && /^[1-8]4$/.demo(y))
//                            continue
//                    } else if (5 == i) {
//                        if ("string" == typeof y && !/^[5-8]2$/.demo(y))
//                            continue
